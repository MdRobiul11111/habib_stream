...
class WheatMode extends StatefulWidget {
  const WheatMode({super.key});

  @override
  State<WheatMode> createState() => _WheatModeState();
}

class _WheatModeState extends State<WheatMode> {
  @override
