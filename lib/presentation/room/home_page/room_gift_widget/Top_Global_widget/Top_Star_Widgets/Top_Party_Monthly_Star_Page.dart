...
class TopPartyMonthlyStarPage extends StatefulWidget {
  const TopPartyMonthlyStarPage({super.key});

  @override
  State<TopPartyMonthlyStarPage> createState() =>
      _TopPartyMonthlyStarPageState();
}

class _TopPartyMonthlyStarPageState extends State<TopPartyMonthlyStarPage> {
  @override
