...
class TopPartyWeeklyPage extends StatefulWidget {
  const TopPartyWeeklyPage({super.key});

  @override
  State<TopPartyWeeklyPage> createState() => _TopPartyWeeklyPageState();
}

class _TopPartyWeeklyPageState extends State<TopPartyWeeklyPage> {
  @override
