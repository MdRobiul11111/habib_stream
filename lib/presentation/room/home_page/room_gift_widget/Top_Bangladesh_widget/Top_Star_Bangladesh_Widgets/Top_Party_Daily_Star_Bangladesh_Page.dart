...
class TopPartyDailyStarBangladeshPage extends StatefulWidget {
  const TopPartyDailyStarBangladeshPage({super.key});

  @override
  State<TopPartyDailyStarBangladeshPage> createState() =>
      _TopPartyDailyStarBangladeshPageState();
}

class _TopPartyDailyStarBangladeshPageState
    extends State<TopPartyDailyStarBangladeshPage> {
  @override
