...
class TopPartyWeeklyStarBangladeshPage extends StatefulWidget {
  const TopPartyWeeklyStarBangladeshPage({super.key});

  @override
  State<TopPartyWeeklyStarBangladeshPage> createState() =>
      _TopPartyWeeklyStarBangladeshPageState();
}

class _TopPartyWeeklyStarBangladeshPageState
    extends State<TopPartyWeeklyStarBangladeshPage> {
  @override
