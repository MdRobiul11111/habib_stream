...
class TopPartyMonthlyBangladeshPage extends StatefulWidget {
  const TopPartyMonthlyBangladeshPage({super.key});

  @override
  State<TopPartyMonthlyBangladeshPage> createState() =>
      _TopPartyMonthlyBangladeshPageState();
}

class _TopPartyMonthlyBangladeshPageState
    extends State<TopPartyMonthlyBangladeshPage> {
  @override
