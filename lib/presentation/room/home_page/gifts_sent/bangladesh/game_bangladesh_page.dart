...
class Gifts_sent_GameBdPage extends StatefulWidget {
  const Gifts_sent_GameBdPage({super.key});

  @override
  State<Gifts_sent_GameBdPage> createState() => _Gifts_sent_GameBdPageState();
}

class _Gifts_sent_GameBdPageState extends State<Gifts_sent_GameBdPage> {
  @override
