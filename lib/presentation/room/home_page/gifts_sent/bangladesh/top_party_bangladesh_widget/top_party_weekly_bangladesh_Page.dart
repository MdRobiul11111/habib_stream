...
class Gifts_sent_TopPartyWeeklyBdPage extends StatefulWidget {
  const Gifts_sent_TopPartyWeeklyBdPage({super.key});

  @override
  State<Gifts_sent_TopPartyWeeklyBdPage> createState() =>
      _Gifts_sent_TopPartyWeeklyBdPageState();
}

class _Gifts_sent_TopPartyWeeklyBdPageState
    extends State<Gifts_sent_TopPartyWeeklyBdPage> {
  @override
