...
class TopPartyDailyGiftersPage extends StatefulWidget {
  const TopPartyDailyGiftersPage({super.key});

  @override
  State<TopPartyDailyGiftersPage> createState() =>
      _TopPartyDailyGiftersPageState();
}

class _TopPartyDailyGiftersPageState extends State<TopPartyDailyGiftersPage> {
  @override
