...
class Gifts_sent_TopPartyDailyStarPage extends StatefulWidget {
  const Gifts_sent_TopPartyDailyStarPage({super.key});

  @override
  State<Gifts_sent_TopPartyDailyStarPage> createState() =>
      _Gifts_sent_TopPartyDailyStarPageState();
}

class _Gifts_sent_TopPartyDailyStarPageState
    extends State<Gifts_sent_TopPartyDailyStarPage> {
  @override
