...
class Gifts_sent_TopPartyWeeklyStarPage extends StatefulWidget {
  const Gifts_sent_TopPartyWeeklyStarPage({super.key});

  @override
  State<Gifts_sent_TopPartyWeeklyStarPage> createState() =>
      _Gifts_sent_TopPartyWeeklyStarPageState();
}

class _Gifts_sent_TopPartyWeeklyStarPageState
    extends State<Gifts_sent_TopPartyWeeklyStarPage> {
  @override
