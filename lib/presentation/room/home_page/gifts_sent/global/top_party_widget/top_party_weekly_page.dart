...
class Gifts_sent_TopPartyWeeklyPage extends StatefulWidget {
  const Gifts_sent_TopPartyWeeklyPage({super.key});

  @override
  State<Gifts_sent_TopPartyWeeklyPage> createState() =>
      _Gifts_sent_TopPartyWeeklyPageState();
}

class _Gifts_sent_TopPartyWeeklyPageState
    extends State<Gifts_sent_TopPartyWeeklyPage> {
  @override
