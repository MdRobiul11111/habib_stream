...
class Gifts_sent_TopPartyDailyPage extends StatefulWidget {
  const Gifts_sent_TopPartyDailyPage({super.key});

  @override
  State<Gifts_sent_TopPartyDailyPage> createState() =>
      _Gifts_sent_TopPartyDailyPageState();
}

class _Gifts_sent_TopPartyDailyPageState
    extends State<Gifts_sent_TopPartyDailyPage> {
  @override
