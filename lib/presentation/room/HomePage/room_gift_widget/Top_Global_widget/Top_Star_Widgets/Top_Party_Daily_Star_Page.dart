...
class TopPartyDailyStarPage extends StatefulWidget {
  const TopPartyDailyStarPage({super.key});

  @override
  State<TopPartyDailyStarPage> createState() => _TopPartyDailyStarPageState();
}

class _TopPartyDailyStarPageState extends State<TopPartyDailyStarPage> {
  @override
