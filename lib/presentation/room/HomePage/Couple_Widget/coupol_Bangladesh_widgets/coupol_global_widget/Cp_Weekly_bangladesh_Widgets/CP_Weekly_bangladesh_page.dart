...
class CpWeeklyBangladeshPage extends StatefulWidget {
  const CpWeeklyBangladeshPage({super.key});

  @override
  State<CpWeeklyBangladeshPage> createState() => _CpWeeklyBangladeshPageState();
}

class _CpWeeklyBangladeshPageState extends State<CpWeeklyBangladeshPage> {
  @override
