...
class TopPartyWeeklyBangladeshPage extends StatefulWidget {
  const TopPartyWeeklyBangladeshPage({super.key});

  @override
  State<TopPartyWeeklyBangladeshPage> createState() =>
      _TopPartyWeeklyBangladeshPageState();
}

class _TopPartyWeeklyBangladeshPageState
    extends State<TopPartyWeeklyBangladeshPage> {
  @override
