...
class TopPartyDailyBangladeshPage extends StatefulWidget {
  const TopPartyDailyBangladeshPage({super.key});

  @override
  State<TopPartyDailyBangladeshPage> createState() =>
      _TopPartyDailyBangladeshPageState();
}

class _TopPartyDailyBangladeshPageState
    extends State<TopPartyDailyBangladeshPage> {
  @override
