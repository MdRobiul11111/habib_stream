...
class TopPartyMonthlyStarBangladeshPage extends StatefulWidget {
  const TopPartyMonthlyStarBangladeshPage({super.key});

  @override
  State<TopPartyMonthlyStarBangladeshPage> createState() =>
      _TopPartyMonthlyStarBangladeshPageState();
}

class _TopPartyMonthlyStarBangladeshPageState
    extends State<TopPartyMonthlyStarBangladeshPage> {
  @override
