...
class CpTotalPage extends StatefulWidget {
  const CpTotalPage({super.key});

  @override
  State<CpTotalPage> createState() => _CpTotalPageState();
}

class _CpTotalPageState extends State<CpTotalPage> {
  @override
