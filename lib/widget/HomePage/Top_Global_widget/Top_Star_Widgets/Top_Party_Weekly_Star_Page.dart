...
class TopPartyWeeklyStarPage extends StatefulWidget {
  const TopPartyWeeklyStarPage({super.key});

  @override
  State<TopPartyWeeklyStarPage> createState() => _TopPartyWeeklyStarPageState();
}

class _TopPartyWeeklyStarPageState extends State<TopPartyWeeklyStarPage> {
  @override
