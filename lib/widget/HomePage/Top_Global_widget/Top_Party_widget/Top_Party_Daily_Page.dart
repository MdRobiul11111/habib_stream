...
class TopPartyDailyPage extends StatefulWidget {
  const TopPartyDailyPage({super.key});

  @override
  State<TopPartyDailyPage> createState() => _TopPartyDailyPageState();
}

class _TopPartyDailyPageState extends State<TopPartyDailyPage> {
  @override
