...
class TopPartyWeeklyGiftersPage extends StatefulWidget {
  const TopPartyWeeklyGiftersPage({super.key});

  @override
  State<TopPartyWeeklyGiftersPage> createState() =>
      _TopPartyWeeklyGiftersPageState();
}

class _TopPartyWeeklyGiftersPageState extends State<TopPartyWeeklyGiftersPage> {
  @override
